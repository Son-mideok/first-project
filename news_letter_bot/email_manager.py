...
def send_mail(from_user:str, to_users:list, subject:str, content:str, attachments:list=[], cc_targets=[]) -> bool:
    ...
    **선택**
    ...
    try:
        ...
        smtp.sendmail(from_user, ','.join(set(to_users+cc_targets)), msg.as_string())
        print('이메일 발송 성공 !')
...
if __name__ == '__main__':
    send_mail('dnrl52@naver.com', 
    ['dnrl52@gmail.com', 'v_vb@naver.com'],
    subject='저도 보낼거에요.', content='잘 받으셨죠??',
    attachments=['./실습5/커리큘럼.xlsx', './실습3/result.xlsx'])